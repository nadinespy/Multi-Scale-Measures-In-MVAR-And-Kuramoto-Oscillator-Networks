%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% sim_mvar_model_with_lagged_cov.m
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% sim_mvar_model_with_lagged_cov() simulates a time-series of a multivariate 
% autoregressive network using the full time-lagged covariance.
%
% ADD MORE DOCUMENTATION
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

function [micro corr_micro] = sim_mvar_model_with_lagged_cov(n_datapoints, ...
		full_time_lagged_cov, couplings, ar_model_order)
...
covariance 	= full_time_lagged_cov(1:(length(full_time_lagged_cov)/2), ...
	1:(length(full_time_lagged_cov)/2));						% get same-time covariance of network 
