...
% get_DD() calculates DD for any micro and macro variable specified in 
% [micro_variables] and [macro_variables],and the parameters given; 
% 
% Takes as inputs the method ([method]), time-lag ([time_lag]),
% DD-specific measure parameter [time_step], and micro and macro 
% variables ([micro_variable], [macro_variable]). 
% 
% Example: all_DD = get_DD(micro_variables, macro_variables, method, ...
%	     time_lag, time_step, 'kraskov_param', kraskov_param)
% 
% INPUTS - required
...
%
% OUTPUTS:	
%    all_DD			    -			1x1 struct with with micro- 
