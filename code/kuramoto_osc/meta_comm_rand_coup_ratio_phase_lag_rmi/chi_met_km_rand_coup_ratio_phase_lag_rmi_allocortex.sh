...
simname=chi_met_km_rand_coup_ratio_phase_lag_rmi

# Base directory for code,etc
basedir="/its/home/ns508"

# Directory to run Matlab in
rundir=$basedir"/scripts/kuramoto_osc/meta_comm_rand_coup_ratio_phase_lag_rmi"
...
parmscripts=(
    	"params_chi_met_km_rand_coup_ratio_phase_lag_rmi"
)
