function get_optimised_dd(mdim)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if full_coupling_matrix
	H = var2trfun(decorr_coupling_matrix,frequency_res);
else
	H = ss2trfun(decorr_higher_dim_coupling_matrix, decorr_obs_state_var, decorr_kalman_var,frequency_res);
end

fprintf('%s: optimisation (fres = %d) for m = %d\n',mdescript,frequency_res,m);
...
Lopto = itransform_subspace(Lo,noise_corr);
