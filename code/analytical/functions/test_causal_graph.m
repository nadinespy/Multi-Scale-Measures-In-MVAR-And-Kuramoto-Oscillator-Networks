function [outcome1 outcome2] = test_causal_graph(coupling_matrix, time_length)
...
[h,r] = kuramoto(N,w,coupling_matrix,phase_lag,n,dt,I, 'Euler');
...
yes_or_no = input('Keep this KM simulation? If yes, type 1 and enter.');
close all;
