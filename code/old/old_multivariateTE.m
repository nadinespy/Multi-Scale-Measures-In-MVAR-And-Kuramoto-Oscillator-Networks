...
teCalc = javaObject('infodynamics.measures.discrete.TransferEntropyCalculatorDiscrete', 512, 1); % 4: base - number of symbols for each variable. 
...
teCalc.addObservations(mUtils.computeCombinedValues(octaveToJavaDoubleMatrix(bin_raw_signal), 512), ...
		mUtils.computeCombinedValues(octaveToJavaDoubleMatrix(bin_raw_signal), 512));
