	...
	for q = 1:length(all_npoints);
		...
		for z = 1:length(taus);
			...
			variables = {practCE.pract_ce_bin_phase_bin_grand_mean_pair_sync, ...
				...
				practCE.pract_dc_bin_phase_bin_grand_mean_pair_sync, ...
				practCE.pract_dc_bin_raw_signal_bin_grand_mean_pair_sync, ...
				practCE.pract_dc_bin_synchrony_bin_grand_mean_pair_sync, ...
				practCE.pract_cd_bin_phase_bin_grand_mean_pair_sync, ...
				practCE.pract_cd_bin_raw_signal_bin_grand_mean_pair_sync, ...
				practCE.pract_cd_bin_synchrony_bin_grand_mean_pair_sync};
			...
			file_names = {'pract_ce_bin_phase_bin_grand_mean_pair_sync', ...
				...
				'pract_dc_bin_phase_bin_grand_mean_pair_sync', ...
				'pract_dc_bin_raw_signal_bin_grand_mean_pair_sync', ...
				'pract_dc_bin_synchrony_bin_grand_mean_pair_sync', ...
				'pract_cd_bin_phase_bin_grand_mean_pair_sync', ...
				'pract_cd_bin_raw_signal_bin_grand_mean_pair_sync', ...
				'pract_cd_bin_synchrony_bin_grand_mean_pair_sync'};
