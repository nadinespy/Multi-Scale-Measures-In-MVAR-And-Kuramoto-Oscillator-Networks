function get_all_DD_heatmaps(network, time_series_length, measure_params, x_axis, y_axis, ...
		x_label, y_label, pathout_data_pract_ce, pathout_plots_pract_ce)
	...
	for q = 1:length(time_series_length);
		...
		for z = 1:length(measure_param1);
			...
			load([pathout_data_pract_ce network '_all_DD_' num2str(time_series_length(q)) '_' num2str(measure_param1(z)) '.mat'], ...
				'all_DD');
